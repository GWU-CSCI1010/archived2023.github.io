...
<table class="table table-hover w-auto">
  ...
  <tbody>
    <tr class="table-active">
      ...
      <td>
        <ul>
          ...
          <li>Introduction to programming by **Prof. Kartik Bulusu**</li>
        </ul>  
      </td>
      <td>
        <ul>
    ...
    <tr class="table-active">
      ...
      <td>
        <ul>
          <li>Very brief introduction to matrices by **Prof. Kartik Bulusu**</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Short walk into Python Libraries</li>
