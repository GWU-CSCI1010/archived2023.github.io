...
---
## Goal 
The goal of the course is to introduce the students to the various areas of study and research in the field of computer science. 

## Learning objectives
1. Hands-on knowledge of sensors and hardware and, programming with Python programming language 
2. Exposure to various fields of study and research in computer science

## Learning Outcomes
As a result of completing this course, students will be able to:

1. Understand the various areas of work and research in Computer Science.
2. Perform experiments and analyzing data.
3. Design and write Python programs.
4. Work on a group project.
...
## Course format 
- Lectures on the fundamentals of Python programming and some expsure to sensors and automation. 
- Hands-on and guided activities in a laboratory setting. 
- Guest lectures from academic experts in the field of computer science
